...
function getFallbackResponse(userText) {
  ...
  if (lower.includes("почитать") || lower.includes("читать") || lower.includes("котик")) {
  ...
  if (lower.includes("спать") || lower.includes("сказка")) {
    return "День был чудесным и радостным, и глазки просят отдыха. Включаем волшебную сказку-медитацию на ночь моим голосом или родным голосом твоей мамы? Будем сладко засыпать 🌙";
  }
  return "Какая интересная мысль, и я с радостью поддержу тебя! О чем поболтаем — о забавных кошках или о тайнах города?";
}
